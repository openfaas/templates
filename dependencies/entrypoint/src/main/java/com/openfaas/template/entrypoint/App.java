...
package com.openfaas.template.entrypoint;

import com.openfaas.template.model.IHandler;
import com.openfaas.template.model.IRequest;
import com.openfaas.template.model.IResponse;
import com.openfaas.template.model.Request;
...
public class App {
    ...
    private static Object loadTheFunctionHandler(String classBinName){
        ...
        try {
            ...
            ClassLoader classLoader =    com.openfaas.template.entrypoint.App.class.getClassLoader();
